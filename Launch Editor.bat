@echo off
title Tornado Shelter Sim - Editor Launcher
cls

echo.
echo ================================================
echo     TORNADO SHELTER SIM - EDITOR
echo     Spring Jam 26
echo ================================================
echo.
...
if exist "C:\Program Files\Godot\Godot_v4.6.3-stable_win64.exe" set "GODOT_EXE=C:\Program Files\Godot\Godot_v4.6.3-stable_win64.exe"
...
if exist "D:\Godot\Godot_v4.6.3-stable_win64.exe" set "GODOT_EXE=D:\Godot\Godot_v4.6.3-stable_win64.exe"
...
echo     2. Find your Godot.exe file
echo     3. DRAG AND DROP the Godot.exe file onto this window
